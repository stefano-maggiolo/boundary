...
\begin{proof}
  ...
  breaking position. Notice that if it occurs in the matrix $a$
  (equivalently, in the last $K$ rows), it is actually the first
  breaking position of its column.
\end{proof}
