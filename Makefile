...
FLAGS = -O2 -DREVISION=$Revision$ -DUSE_NAUTY -DUSE_LINES_NO_MAP -DUSE_DEGREES_NO_MAP 
#FLAGS = -O2 -DREVISION=$Revision$ -DUSE_LINES_NO_MAP -DUSE_DEGREES_NO_MAP -llapackpp -DSTART_LAPACK_COMPUTATION=9
